...
namespace BluethoothChatUwp.ViewModels
{
    internal class MainPageViewModel
        : ViewModel
    {
        private readonly IRfcommChatServer _model;

        public MainPageViewModel(IRfcommChatServer model)
		{
        ...
        private AsyncCommand _listenCommand;

        public AsyncCommand ListenCommand => GetCommand(ref _listenCommand, DoListen);
